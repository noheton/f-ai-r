...
The ladder is the finite-state machine of the \paperref{sec:ladder}{verification ladder section}.
This appendix supplies the per-rung specification used by the
Source Analyzer (\paperref{sec:pipeline}{pipeline section}) and the Aligner.
...
practice (\paperref{sec:eight}{eight integrated practices}, item~6).
