...
% Its content was superseded when the paper was reframed as a position
% paper: the rhetorical material moved to sections/objections.tex, the
% submission-conditions paragraph moved to sections/conclusion.tex, the
% authorship paragraph moved to sections/statement-of-authorship.tex.
% The file is preserved (not deleted) so the prior framing remains in
% the git history without orphaning the corresponding fair2r:Section IRI.
\section{Discussion (superseded)}
