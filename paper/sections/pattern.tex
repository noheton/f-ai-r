...
\paragraph{Crosswalk.} Retrieval depth maps to PRISMA
2020~\cite{page2021prisma}: \textsc{lit-retrieved}\,=\,Identification,
\textsc{ai-confirmed}\,=\,Screening,
\textsc{lit-read}\,=\,Included. Invocation strength maps to
GRADE~\cite{guyatt2008grade}: a
...
The pattern composes with two forward-looking extensions ---
domain ontologies (SOSA / SSN, OM-2 / QUDT) for sub-discipline
value semantics, and provenance-graph interconnectivity (the
bioinformatics precedent under data-volume pressure, restated
for LLM-assisted scholarship), both recorded in
Appendix~\ref{sec:appendix-pattern-extensions}. Read structurally,
F(AI)\textsuperscript{2}R borrows more from
