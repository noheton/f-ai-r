...
and constant
=======
volume but high in leverage; model outputs are long and constant
>>>>>>> origin/main
...
\bigskip
\noindent The rest of the paper assumes you read it in that
spirit. \S\ref{sec:position} states the position in five numbered
claims; \S\ref{sec:pattern}--\S\ref{sec:eight} defend it;
\S\ref{sec:limits-and-objections} addresses dual-use, sustainability,
and the standing objections.
>>>>>>> origin/main
