...
summarise \S\ref{sec:axes}; the full mapping is in the
\emph{F(AI)\textsuperscript{2}R Cell Mapping} section
(Appendix~C) of the companion technical
report~\cite{krebs2026faiarcompanion}.}
\label{fig:axes}
\end{figure}
