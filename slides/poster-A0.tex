% F(AI)^2R conference poster, A0 landscape, three-column.
%
...
% Output:   poster-A0.pdf  (A0 landscape, ~841 x 1189 mm)
%
...
\documentclass[25pt, a0paper, landscape, margin=20mm,
...
\begin{center}
\includegraphics[width=0.95\linewidth]{../paper/figures/hero.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.96\linewidth]{../paper/figures/ladder-populations.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.96\linewidth]{../paper/figures/provenance-topology.png}
\end{center}
