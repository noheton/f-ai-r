...
\documentclass[30pt, a0paper, portrait, margin=20mm,
               innermargin=12mm, colspace=14mm,
               subcolspace=4mm, blockverticalspace=14mm]{tikzposter}
...
\begin{tabular}{rp{0.55\linewidth}}
...
\block{Contribution shape}{
\begin{center}
\includegraphics[width=\linewidth]{contribution-histogram.png}
\end{center}
Human-author contributions to this manuscript by type, read live
...
interventions are the catch-and-fix work; \textbf{responsibility-
uptake} is the leg of the contribution the AI structurally
cannot share.
}

\block{The eight failure modes the practices cover}{
\textbf{Fabricated citations} (Practice 2 + 6).
\textbf{Drift between claim and evidence} (3).
\textbf{Sloppification} (5).
\textbf{Hedge accretion} (5 + readability scrutinizer).
\textbf{Boilerplate disclosure} (6).
\textbf{Authorship laundering} (7).
\textbf{Pre-publication leakage}, \textbf{audience fatigue},
and \textbf{adversarial review} are named as residual; the
discipline does not claim to catch them.
}
...
\begin{center}
\includegraphics[width=\linewidth]{ladder-populations.png}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth]{provenance-topology.png}
\end{center}
...
\centering\normalsize\mdseries
This poster, the position paper it summarises, the
\textbf{companion technical report}, the prompts, the
provenance graph, the logbook, two slide decks, and the build
pipeline are all in the public repository.\\[3mm]
\itshape\color{dlrGrau1}
An LLM makes the overview cheap; true novelty --- the unasked
question, the not-yet-thinkable abstraction --- remains a human
quality the models do not match \emph{yet}: a claim about the
present, dated by the version manifest, not a guarantee.\\[3mm]
\upshape\large\color{dlrBlau1}\bfseries
